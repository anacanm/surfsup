defmodule ParserTest do
  ...
  test "insert_keys_into_row_data" do
    ...
    expected_result = ["year", "2020", "month", "06", "day", "07", "hour", "15", "minute", "26",
    "wave_height", "1.5", "swell_height", "0.5", "swell_period", "15.4",
    "wind_wave_height", "1.4", "wind_wave_period", "7.1", "swell_direction", "SSW",
    "wind_wave_direction", "WSW", "steepness", "STEEP", "average_wave_period",
    "6.4", "mean_wave_direction", "256"]
